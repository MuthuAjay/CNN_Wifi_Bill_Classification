...
class TransformData:
    ...
    @staticmethod
    def data_transform(augment: bool = True,
                       image_size: Tuple[int, int] = (64, 64)) -> Tuple[transforms.Compose, transforms.Compose]:
        """
        ...
        Args:
            ...
            image_size (Tuple[int, int]) : the size of the image to transform
